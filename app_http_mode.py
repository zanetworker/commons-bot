...
template_transcripts = (
    "Your context is a list of youtube transcript. Each transcript is for a video that talks about a certain topic \n"
    "---------------------\n"
    "{context_str}"
    "\n---------------------\n"
    "You are a helpful AI assistant who can pick the best information from the transcripts. \n"
    "give me the most relevant information from the context I gave you and start your reply with \"here is some additional information you might like\" and share the URL: {query_str}\n"
)
